...
const AvatarIcon = () => {
  return (
    <svg
      ...
      width="40" // Set to 100px
      height="40" // Set to 100px
    >
      <g>
        <circle fill="#13AEC0" cx="72.387" cy="72.386" r="72.386" />
        <g>
          <defs>
          ...
          <g style={{ clipPath: "url(#SVGID_2_)" }}>
            ...
            <path
              fillOpacity="0.1"
              fill="#DDAC8C"
              d="M64.22,97.273c1.469,4.217,7.397,6.634,11.751,6.634c1.575,0,3.107-0.264,4.583-0.747
            ...
            <path
              fill="#E4B692"
              d="M90.19,79.197c-3.807-0.399-6.377-4.5-5.733-9.156c0.637-4.66,4.242-8.12,8.051-7.724
            ...
            <path
              fill="#265A68"
              d="M52.188,73.014c0,0,2.888-5.551,4.12-16.22c8.713,8.279,18.978,9.604,32.546,0
            ...
            <path
              fill="#2D5972"
              d="M107.053,116.94c-2.99-5.66-16.375-9.966-25.61-12.331c-0.359,4.691-4.272,8.389-9.056,8.389
